...
深度学习框架sensenet的开发与在虚拟化集群上的部署和模型训练工作
\begin{itemize}
  \item 实现sensenet的一些layer的前向传播和后向传播
  \item 实现sensenet在k8s集群上的部署和GPU支持、heapster资源监控和mpi多机多卡并行训练网络
  \item 工具:caffe,tensorflow,k8s,docker,slurm,openmpi,heapster等
\end{itemize}
...
\section{\faCogs\ 项目经历}
\datedsubsection{\textbf{多源物端视频监控项目}}{2016年10月 -- 至今}
\role{项目策划与算法研究}{}
%\begin{onehalfspacing}
搭建一套视频监控平台，实现运动目标检测与跟踪、深度学习模型压缩优化、视频结构化存储与检索
\begin{itemize}
  \item 设计组合特征与BOW模型实现目标结构化存储与检索
  \item 研究TLD、MDNet、GoTurn等跟踪算法和squeezenet等DL模型，并在arm平台上进行压缩优化
\end{itemize}
%\end{onehalfspacing}
